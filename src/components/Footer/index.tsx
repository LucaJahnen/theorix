...
const Footer = () => {
    ...
    return (
        <footer className="px-4 py-[10%] bg-footer mt-14 lg:grid lg:grid-cols-2 lg:py-[3%] lg:px-[10%] lg:m-auto lg:mt-14 text-foreground">
            <Link to="/" className="text-lg lg:row-start-1 font-serif"><span className="text-secondary font-sans">theo</span>rix</Link>
            ...
            <section className="mt-5 lg:row-start-3 lg:col-start-2 lg:max-w-80 lg:justify-self-end lg:text-right">
                <p>Our website runs on your support and is not funded by ads. If you enjoy our content, please consider <Link to="/" className="underline">donating</Link>.</p>
            </section>
        </footer>
    )
}
